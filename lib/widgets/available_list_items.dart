                                            ...
                                            child: Obx(
                                              ...
                                              return  IconButton(
                                                  ...
                                                  icon: ImageIcon(AssetImage( tapped.value
                                                      ...
                                                      : AppAssets.likeImg,
                                                  ),size: 18.sp,color: tapped.value ? AppColors.redColor : AppColors.hintText,)
                                              );
                                            }
                                        ))
                                      ],
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text(TempLanguage.txtSuperDuper, style: poppinsBold(fontSize: 13.sp),),
                                              Container(
                                                height: 15,
                                                width: 40,
                                          ...
                                          Text(TempLanguage.txtRestaurantName, style: poppinsRegular(fontSize: 12.sp, color: AppColors.hintText),),
                                          Row(
                                            children: [
                                              Icon(Icons.star_half, color: AppColors.yellowColor, size: 15.sp,),
                                              Text('4.4', style: poppinsRegular(fontSize: 11.sp, color: AppColors.yellowColor),),
                                              Text('15K', style: poppinsRegular(fontSize: 11.sp, color: AppColors.yellowColor),)
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: Row(
                                                  children: [
                                                    Expanded(child: Text('4773 Waldeck Street, US', style: poppinsRegular(fontSize: 11.sp, color: AppColors.hintText),maxLines: 2,)),
