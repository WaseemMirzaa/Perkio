            ...
            child: Column(
              ...
              children: [
                ...
                Obx(()=> controller.loading.value
                  ...
                  }else if(homeController.pickedImage == null && widget.dealModel.image.isEmptyOrNull){
                    showSnackBar('Deal Logo','Deal Logo is required');
                  }
                  else{
                  ...
                  await controller.editMyDeal(widget.dealModel).then((value) {
