...
class BusinessDetailTile extends StatelessWidget {
  const BusinessDetailTile({super.key});
                ...
                children: [
                  ...
                  GestureDetector(
                      onTap: () {
                        ...
                        //     context,
                        //     MaterialPageRoute(
                        //         builder: (context) => const BusinessDetail()));
                        Get.back();
                      },
                      child: Text(
