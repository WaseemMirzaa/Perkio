...
class RewardsListItems extends StatefulWidget {
  ...
  final String? userId;
  final bool isFavFromFavScreen;

  const RewardsListItems({
    super.key,
    this.reward,
    this.isFavFromFavScreen = false,
    this.userId,
  });
                              ...
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: (widget.reward?.rewardLogo
                                                ?.isNotEmpty ??
                                            false)
                                        ? Image.network(
                      ...
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: (widget.reward?.rewardLogo?.isNotEmpty ??
                                    false)
                                ? Image.network(
                                    widget.reward!.rewardLogo!,
                                    fit: BoxFit.cover,
