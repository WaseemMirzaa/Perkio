                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(color: AppColors.whiteColor,
                                              ...
                                              image: DecorationImage(image: NetworkImage(widget.dealModel.image!),fit: BoxFit.cover),)),
                                          const SpacerBoxHorizontal(width: 10),
                                          Expanded(
                                            child: Column(
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Row(
                                                      children: [
                                                        Expanded(child: Text(widget.dealModel.location ?? "", style: poppinsRegular(fontSize: 10.sp, color: AppColors.hintText),maxLines: 2,)),
                                                ...
                                                Text('${widget.dealModel.noOfUsedTellNow} People used by now', style: poppinsRegular(fontSize: 10.sp, color: AppColors.hintText,),maxLines: 1,),
                                                SizedBox(height: 1.h,),
                                                Padding(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              IconButton(
                                                  ...
                                                  onPressed: (){
                                                Get.to(()=> EditMyDeals(dealModel: widget.dealModel));
                                              }, icon: ImageIcon(const AssetImage(AppAssets.editImg),size: 15.sp,color: AppColors.blackColor)),
                                              IconButton(
                                                  padding: EdgeInsets.zero,
                                                  onPressed: (){
                                                showAdaptiveDialog(context: context, builder: (context)=> AlertDialog(title: Text('Deal Deletion',style: poppinsMedium(fontSize: 14.sp),),content: const Text('Are you sure you want to delete the deal?'),actions: [
                                                  ...
                                                  TextButton(
                                                      onPressed: ()async{
                                                   await businessController.deleteDeal(widget.dealModel.dealId!, widget.dealModel.image!).then((value)=>Get.back());
                                          ...
                                          widget.dealModel.isPromotionStar! ? Column(children: [
                                            Padding(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    Text(widget.dealModel.likes.toString(), style: poppinsMedium(fontSize: 10),),
                                                ...
                                                Column(
                                                  children: [
                                                    Text(widget.dealModel.views.toString(), style: poppinsMedium(fontSize: 10),),
                                                ...
                                                GestureDetector(
                                                  onTap: (){
                                                    showAdaptiveDialog(context: context, builder: (context)=> AlertDialog(title: Text('Stop Promotion',style: poppinsBold(fontSize: 14.sp),),content: Text('Do you really want to stop promotion of the deal',style: poppinsRegular(fontSize: 12.sp),),actions: [
                                                      TextButton(onPressed: (){
                                                        Get.back();
                                                      }, child: const Text('No')),
                                                      TextButton(onPressed: ()async{
                                                        await homeController.updateCollection(widget.dealModel.dealId!, CollectionsKey.DEALS,
                                                            {
                                                              DealKey.ISPROMOTIONSTART: false,
                                                              DealKey.VIEWS: 0,
                                                              DealKey.LIKES: 0,
                                                            }).then((value)=>Get.back());
                                                      }, child: const Text('Yes')),
